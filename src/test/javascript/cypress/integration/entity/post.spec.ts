...
describe('Post e2e test', () => {
  ...
  const postSample = { title: 'B2C', content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=', date: '2021-11-08T09:40:23.555Z' };
  ...
  describe('new Post page', () => {
    ...
    it('should create an instance of Post', () => {
      ...
      cy.get(`[data-cy="date"]`).type('2021-11-08T11:04').should('have.value', '2021-11-08T11:04');
